...
public final class AggregateAndRecommendReducer extends
    ...
    private static final Logger log = LoggerFactory.getLogger(org.apache.mahout.cf.taste.hadoop.item.AggregateAndRecommendReducer.class);
    ...
    protected void setup(Context context) throws IOException {
        ...
        booleanData = conf.getBoolean(org.apache.mahout.cf.taste.hadoop.item.RecommenderJob.BOOLEAN_DATA, false);
